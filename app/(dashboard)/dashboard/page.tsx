              ...
              >
                <div className="p-6">
                  ...
                  <div className="flex items-start justify-between mb-4">
                    ...
                    {quiz.isPublished ? (
                      <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-gradient-to-r from-green-100 to-emerald-100 text-green-800 ml-3">
                      ...
                      <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-gradient-to-r from-gray-100 to-gray-200 text-gray-700 ml-3">
                        <svg className="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
